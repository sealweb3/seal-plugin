...
import { Attestation, AttestationDelegationSignature, RevokeDelegationSignature, SchemaDelegationSignature, OnChainSchema, RecipientEncodingType } from '../types';
export declare function delegateSignAttestation(attestation: Attestation, options: {
    chain: EvmChains;
