...
export declare class IndexService {
    ...
    querySchema: (schemaId: string) => Promise<SchemaInfo>;
    queryAttestationList: (query: {
        id?: string;
        schemaId?: string;
        attester?: string;
        page: number;
    ...
    queryAttestation: (attestationId: string) => Promise<AttestationInfo>;
}
